...
public class FestivalDTO {
    ...
    public static class FestivalResponseDTO {
        @Schema(description = "콘텐츠 ID", example = "2785797")
        private String contentId;
        @Schema(description = "축제 제목", example = "겨울, 청계천의 빛")
        private String title;
        @Schema(description = "주소", example = "서울특별시 중구 태평로1가 1")
        private String addr1;
        @Schema(description = "이미지1", example = "http://tong.visitkorea.or.kr/cms/resource/32/3045532_image2_1.jpg")
        private String firstImage;
        @Schema(description = "이미지2", example = "http://tong.visitkorea.or.kr/cms/resource/32/3045532_image3_1.jpg")
        private String firstImage2;
        @Schema(description = "축제 시작 날짜", example = "20241213")
        private String eventStartDate;
        @Schema(description = "축제 종료 날짜", example = "20241231")
        private String eventEndDate;
    }
